  ...
  return (
    ...
    >
      <div
        ...
        className={`glass p-8 rounded-xl h-full flex flex-col relative transition-all duration-300 bg-white/10 ${
          plan.isPopular
...
const PricingSection = () => {
  return (
    <section id="pricing" className="section-padding py-24 relative bg-[#0e0f23] px-12">
