...
const About = () => {
  ...
  return (
    <div
      ref={sectionRef}
      className="relative min-h-screen bg-[#0e0f23] text-white pt-24 overflow-hidden"
    >
      ...
      <div className="mx-auto px-6 md:px-12">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center justify-center p-2 bg-purple-700/30 rounded-full mb-4"
          >
        ...
        >
          <motion.div variants={itemVariants} className="bg-white/10 border-[0.5px] p-8 rounded-2xl">
