...
export default function FeaturedGames() {
  return (
    <section className="relative overflow-hidden w-full px-14 sm:px-6 lg:px-24 py-24 bg-gray-300 dark:bg-[#0e0f23] transition-colors duration-500" id="featured-game">
